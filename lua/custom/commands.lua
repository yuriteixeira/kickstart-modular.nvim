...
cmd('FilePath', file_path.copy_absolute, {
  desc = 'Copy the current buffer absolute file path',
})

cmd('RelativeFilePath', file_path.copy_relative, {
  desc = 'Copy the current buffer relative file path',
})
